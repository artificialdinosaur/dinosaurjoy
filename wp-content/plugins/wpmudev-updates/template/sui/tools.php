...
<div class="sui-row-with-sidenav">
		...
		<form method="POST" action="<?php echo esc_url( $urls->tools_url ) . '#analytics'; ?>">
			...
			<?php else : ?>
				...
				<div class="sui-message sui-message-lg">
					...
					<?php elseif ( 'unit' === $membership_data['membership'] ) : ?>
						<p><?php echo __( 'Add basic analytics tracking that doesn\'t require any third party integration, and display the<br>data in the WordPress Admin Dashboard area. This feature requires an active full WPMU DEV<br>membership.', 'wpmudev' ); ?></p>
						<a href="https://premium.wpmudev.org/hub/account/?utm_source=wpmudev-dashboard&utm_medium=plugin&utm_campaign=dashboard_expired_modal_reactivate" class="sui-button sui-button-purple" style="margin-top: 10px;"><?php echo __('Upgrade Membership', 'wpmudev'); ?></a>
					<?php else: ?>
					<p><?php esc_html_e( "Add basic analytics tracking that doesn't require any third party integration, and display the data in the WordPress Admin Dashboard area.", 'wpmudev' ); ?></p>
	...
	<div class="sui-box js-sidenav-content" id="whitelabel" style="display: none;">
		...
		<form method="POST" action="<?php echo esc_url( $urls->tools_url ) . '#whitelabel'; ?>">
			...
			<?php if ( $whitelabel_settings['enabled'] && ( is_wpmudev_member() || 'unit' === $membership_data['membership'] ) ) : ?>
				...
				<div class="sui-box-body">
					...
					<div class="sui-message sui-message-lg">
						<img src="<?php echo esc_url( WPMUDEV_Dashboard::$site->plugin_url . 'assets/images/devman-whitelabel.png' ); ?>"
							 ...
							 class="sui-image"
							 aria-hidden="true" />
						<p><?php echo __( 'Remove WPMU DEV branding from all our plugins and replace it with your own branding for<br>your clients. This feature requires an active WPMU DEV membership.', 'wpmudev' ); ?></p>
						<a href="https://premium.wpmudev.org/hub/account/?utm_source=wpmudev-dashboard&utm_medium=plugin&utm_campaign=dashboard_expired_modal_reactivate" class="sui-button sui-button-purple" style="margin-top: 10px;"><?php echo __('Reactivate Membership', 'wpmudev'); ?></a>
					</div>
					<?php else: ?>
