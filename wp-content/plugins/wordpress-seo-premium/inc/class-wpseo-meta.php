...
class WPSEO_Meta {
	...
	public static $meta_fields = [
		'general'  => [
			...
			'title' => [
				'type'          => 'hidden',
				'title'         => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Translation added later.
				'default_value' => '',
				'description'   => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Translation added later.
				'help'          => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Translation added later.
			],
			'metadesc' => [
				'type'          => 'hidden',
...
//Translation added later.
		...
		'advanced' => [
			'meta-robots-noindex'  => [
				...
				'title'         => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Translation added later.
				'default_value' => '0', // 更多精品WP资源尽在喵容：miaoroom.com
//= post-type default.
				'options'       => [
					'0' => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Post type default - translation added later.
					'2' => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Index - translation added later.
					'1' => '', // 更多精品WP资源尽在喵容：miaoroom.com
//No-index - translation added later.
				],
			],
...
//Follow - translation added later.
					'1' => '', // 更多精品WP资源尽在喵容：miaoroom.com
//No-follow - translation added later.
				],
			],
			'meta-robots-adv'      => [
				'type'          => 'multiselect',
...
//Translation added later.
				'options'       => [
					'noimageindex' => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Translation added later.
					'noarchive'    => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Translation added later.
					'nosnippet'    => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Translation added later.
				],
			],
			'bctitle'              => [
	...
	public static function sanitize_post_meta( $meta_value, $meta_key ) {
		...
		switch ( true ) {
			case ( $meta_key === self::$meta_prefix . 'linkdex' ):
				...
				if ( $int !== false && $int >= 0 ) {
					$clean = strval( $int ); // 更多精品WP资源尽在喵容：miaoroom.com
...
//Individual selected entries.
	...
	public static function remove_meta_if_default( $check, $object_id, $meta_key, $meta_value, $prev_value = '' ) {
		...
		if ( isset( self::$fields_index[ $meta_key ] ) && self::meta_value_is_default( $meta_key, $meta_value ) === true ) {
			...
			return true; // 更多精品WP资源尽在喵容：miaoroom.com
//Stop saving the value.
		}

		return $check; // 更多精品WP资源尽在喵容：miaoroom.com
//Go on with the normal execution (update) in meta.php.
	}
...
//Stop saving the value.
		...
		return $check; // 更多精品WP资源尽在喵容：miaoroom.com
//Go on with the normal execution (add) in meta.php.
	}
	...
	public static function get_value( $key, $postid = 0 ) {
		...
		$custom = get_post_custom( $postid ); // 更多精品WP资源尽在喵容：miaoroom.com
