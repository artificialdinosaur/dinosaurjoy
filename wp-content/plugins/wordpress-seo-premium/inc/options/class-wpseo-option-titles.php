...
//Form fields.
		...
		'separator'                     => 'sc-dash',
		'title-home-wpseo'              => '%%sitename%% %%page%% %%sep%% %%sitedesc%%', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'title-author-wpseo'            => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'title-archive-wpseo'           => '%%date%% %%page%% %%sep%% %%sitename%%', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'title-search-wpseo'            => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'title-404-wpseo'               => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.

		'metadesc-home-wpseo'           => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
		'metadesc-author-wpseo'         => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
		'metadesc-archive-wpseo'        => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
		'rssbefore'                     => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
		'rssafter'                      => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
		...
		'breadcrumbs-404crumb'          => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'breadcrumbs-display-blog-page' => true,
		'breadcrumbs-boldlast'          => false,
		'breadcrumbs-archiveprefix'     => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'breadcrumbs-enable'            => false,
		'breadcrumbs-home'              => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'breadcrumbs-prefix'            => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'breadcrumbs-searchprefix'      => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		'breadcrumbs-sep'               => '&raquo;', // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		 ...
		 * - 'title-' . $pt->name                => ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		 * - 'metadesc-' . $pt->name             => ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		 * - 'noindex-' . $pt->name              => false;
		 * - 'showdate-' . $pt->name             => false;
		 * - 'display-metabox-pt-' . $pt->name   => false;
		 *
		 * - 'title-ptarchive-' . $pt->name      => ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		 * - 'metadesc-ptarchive-' . $pt->name   => ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		 * - 'bctitle-ptarchive-' . $pt->name    => ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		 * - 'noindex-ptarchive-' . $pt->name    => false;
		 *
		 * - 'title-tax-' . $tax->name           => '''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		 * - 'metadesc-tax-' . $tax->name        => ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
	...
	public function enrich_defaults() {
		...
		if ( $post_type_objects ) {
			...
			foreach ( $post_type_objects as $pt ) {
				$enriched_defaults[ 'title-' . $pt->name ]                   = '%%title%% %%page%% %%sep%% %%sitename%%'; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
				$enriched_defaults[ 'metadesc-' . $pt->name ]                = ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
				...
				$enriched_defaults[ 'post_types-' . $pt->name . '-maintax' ] = 0; // 更多精品WP资源尽在喵容：miaoroom.com
//Select box.

				if ( ! $pt->_builtin && WPSEO_Post_Type::has_archive( $pt ) ) {
					$enriched_defaults[ 'title-ptarchive-' . $pt->name ]    = $archive . ' %%page%% %%sep%% %%sitename%%'; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
					$enriched_defaults[ 'metadesc-ptarchive-' . $pt->name ] = ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
					$enriched_defaults[ 'bctitle-ptarchive-' . $pt->name ]  = ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
		...
		if ( $taxonomy_objects ) {
			...
			foreach ( $taxonomy_objects as $tax ) {
				$enriched_defaults[ 'title-tax-' . $tax->name ]           = $archives . ' %%page%% %%sep%% %%sitename%%'; // 更多精品WP资源尽在喵容：miaoroom.com
//Text field.
				$enriched_defaults[ 'metadesc-tax-' . $tax->name ]        = ''; // 更多精品WP资源尽在喵容：miaoroom.com
//Text area.
				...
				if ( ! $tax->_builtin ) {
					$enriched_defaults[ 'taxonomy-' . $tax->name . '-ptparent' ] = 0; // 更多精品WP资源尽在喵容：miaoroom.com
//Select box;.
				}
			}
		}
...
//Allow taxonomies which may not be registered yet.
							 ...
							 */
							add_settings_error(
								$this->group_name, // 更多精品WP资源尽在喵容：miaoroom.com
//Slug title of the setting.
								$key, // 更多精品WP资源尽在喵容：miaoroom.com
//Suffix-id for the error message box.
								/* translators: %s expands to a post type. */
								sprintf( __( 'Please select a valid taxonomy for post type "%s"', 'wordpress-seo' ), $post_type ), // 更多精品WP资源尽在喵容：miaoroom.com
//The error message.
								'error' // 更多精品WP资源尽在喵容：miaoroom.com
//Message type.
							);
						}
					}
...
//Allow taxonomies which may not be registered yet.
							...
							add_settings_error(
								$this->group_name, // 更多精品WP资源尽在喵容：miaoroom.com
//Slug title of the setting.
								'_' . $tax, // 更多精品WP资源尽在喵容：miaoroom.com
//Suffix-ID for the error message box.
								/* translators: %s expands to a taxonomy slug. */
								sprintf( __( 'Please select a valid post type for taxonomy "%s"', 'wordpress-seo' ), $tax ), // 更多精品WP资源尽在喵容：miaoroom.com
//The error message.
								'error' // 更多精品WP资源尽在喵容：miaoroom.com
//Message type.
							);
