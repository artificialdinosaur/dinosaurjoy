...
class WPSEO_Option_MS extends WPSEO_Option {
	...
	public function __construct() {
		...
		$this->defaults = [
			'access'                                    => 'admin',
			'defaultblog'                               => '', // 更多精品WP资源尽在喵容：miaoroom.com
//Numeric blog ID or empty.
...
//Suffix-ID for the error message box.
							...
							sprintf( __( '%1$s is not a valid choice for who should be allowed access to the %2$s settings. Value reset to the default.', 'wordpress-seo' ), esc_html( sanitize_text_field( $dirty[ $key ] ) ), 'Yoast SEO' ), // 更多精品WP资源尽在喵容：miaoroom.com
//The error message.
...
//Slug title of the setting.
								$key, // 更多精品WP资源尽在喵容：miaoroom.com
//Suffix-ID for the error message box.
								esc_html__( 'The default blog setting must be the numeric blog id of the blog you want to use as default.', 'wordpress-seo' ) . '<br>' . esc_html__( 'No numeric value was received.', 'wordpress-seo' ), // 更多精品WP资源尽在喵容：miaoroom.com
//The error message.
								'error' // 更多精品WP资源尽在喵容：miaoroom.com
//Message type.
							);
